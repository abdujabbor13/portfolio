...
import { SiTypescript, SiRedux, SiTailwindcss, SiBootstrap, SiAntdesign, SiMui, SiFigma,
...
export default function App() {
  ...
  const projects = [
    {
      ...
      info: "Ushbu loyiha Adidas brendining rasmiy saytiga o‘xshash tarzda ishlab chiqilgan bo‘lib, unda mahsulotlar ro‘yxati, sahifadan sahifaga otish va buyurtma berish functionlari bor",
      url: "/adidas.shop.jpg",
    ...
    },
    {
      ...
      info: "Ushbu loyihada Redux orqali global state boshqaruvi, Axios yordamida API bilan integratsiya qilingan. Kinolarni olish (GET), qo‘shish (POST), tahrirlash (PUT) va o‘chirish (DELETE) funksiyalari to‘liq qo‘llangan.",
      url: "/redux.movie.jpg",
  ...
  const skills = [
    ...
    { name: "TypeScript basics", icon: <SiTypescript />, color: "#3178C6" },
  ...
  return (
    <div className="w-full min-h-screen bg-gray-100 text-gray-900 dark:bg-gray-900 dark:text-white">
      ...
      {/* HERO */}
      <section id="home" className="pt-28 pb-20 max-w-6xl mx-auto p-4 flex flex-col md:flex-row items-center justify-between gap-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="flex-1">
          <h2 className="text-5xl font-bold mb-4">Hi, I'm <span className="text-blue-500">Abdujabbor</span></h2>
          <p className="text-xl mb-6">Frontend Developer specializing in <span className="font-semibold">JavaScript, React, Redux, TypeScript, Tailwind CSS</span>.</p>
          <div className="flex gap-4 mt-4">
            <a href="#projects" className="px-6 py-3 rounded-2xl bg-blue-600 text-white shadow">View Projects</a>
            <a href="#contact" className="px-6 py-3 rounded-2xl border border-gray-500 dark:border-gray-300">Contact Me</a>
          </div>
        </motion.div>

        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="flex-1 flex justify-center">
          <div className="w-56 h-56 rounded-full bg-gradient-to-r from-blue-500 to-purple-500">
            <img src="/myPhoto.jpg" alt="My Photo" className="w-56 h-56 rounded-full" />
          </div>
        </motion.div>
      </section>
      ...
      <section id="about" className="max-w-6xl mx-auto p-4 py-24">
        ...
        <div className="bg-white dark:bg-gray-800 shadow-xl rounded-3xl p-8 border border-gray-200 dark:border-gray-700">
          <p className="text-lg leading-8 text-gray-700 dark:text-gray-300">
            Hello! My name is <span className="font-semibold text-blue-500">Abdujabbor Abduvahobov</span>.
            I’m a <span className="font-semibold">22-year-old Front-End Developer</span> based in Andijan, Uzbekistan.
            I focus on creating modern, responsive and interactive web applications.
            <br /><br />
            My main tech stack includes
            <span className="font-semibold"> JavaScript, TypeScript, React, Redux, and Tailwind CSS</span>.
            I enjoy building smooth UI experiences and learning new technologies every day.
          </p>
        </div>
      </section>
      ...
      <section id="projects" className="max-w-6xl mx-auto p-4 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          {projects.map((project, idx) => (
            <div key={idx} className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow">
              <div className="w-full bg-gray-300 dark:bg-gray-700 rounded-xl mb-4">
                <img className="rounded-xl" src={project.url} alt="project image" />
              </div>
              <h3 className="text-xl font-bold mb-2">{project.title}</h3>
              <p className="mb-4 text-gray-600 dark:text-gray-300">{project.info}</p>
              <div className="flex gap-4">
                <a className="px-4 py-2 bg-blue-600 text-white rounded-xl" href={project.versel} target="_blank">Live Demo</a>
                <a className="px-4 py-2 border rounded-xl" href={project.github} target="_blank">GitHub</a>
              </div>
            </div>
          ))}
        </div>
      ...
      <section id="contact" className="max-w-6xl mx-auto p-4 py-24">
        ...
        <div className="flex flex-col gap-5 text-lg bg-white dark:bg-gray-800 p-8 rounded-3xl shadow-lg border border-gray-200 dark:border-gray-700">
          ...
          {/* Email */}
          <a
            href="mailto:abduvahobovabdujabbor7@gmail.com" target="_blank"
          ...
          {/* GitHub */}
          <a
            href="https://github.com/abdujabbor13" target="_blank"
          ...
          {/* Instagram */}
          <a
            href="https://www.instagram.com/ja660r.x/" target="_blank"
